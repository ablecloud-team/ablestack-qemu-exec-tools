...
function Run-Sysprep {
    ...
    function Invoke-SysprepOnce {
        ...
        # sysprep???ÑÎ¶¨-Í≤ÄÏ¶??§Ìå®?úÏóê??0?ºÎ°ú ?ùÎÇ† ???àÏúºÎØÄÎ°?ExitCode??Ï∞∏Í≥†Îß?
    ...
    function Get-OffendingPackages {
        ...
        # ?ºÏù∏ ?ûÏùò ?Ä?ÑÏä§?¨ÌîÑÎ•??åÏã± - "2025-08-30 14:01:17, Error SYSPRP Package ..."
